  ...
  return (
    ...
    >
      <header>
        <div
          aria-hidden
          className="mb-5 h-4 w-20 animate-pulse rounded bg-[var(--chip-bg)]"
        />
        <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-start">
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              <div
                aria-hidden
                className="h-6 w-20 animate-pulse rounded-full bg-[var(--chip-bg)]"
              />
            </div>
            <div
              aria-hidden
              className="mt-2 h-5 w-40 animate-pulse rounded bg-[var(--chip-bg)]"
            />
          </div>
          <div
            aria-hidden
            className="h-9 w-40 animate-pulse rounded-lg bg-[var(--chip-bg)]"
          />
        </div>
      </header>
