...
export type DependencyStateBucket = { start: string; state: DependencyState | null };
...
export function mapDependencyBucketsToTimeline(buckets: readonly DependencyStateBucket[], bucketMs: number): TimelineBucket[] {
