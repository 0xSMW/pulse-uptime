...
describe("UserMenu", () => {
  ...
  it("shows name initials in the trigger frame when a name is set", () => {
    const html = renderToStaticMarkup(<UserMenu email="ops@example.com" name="Ada Lovelace" />);
  ...
  it("renders the uploaded avatar in the trigger frame when set", () => {
    const html = renderToStaticMarkup(
      <UserMenu email="ops@example.com" avatarImageId="11111111-1111-4111-8111-111111111111" />,
    );
    expect(html).toContain('src="/api/v1/images/11111111-1111-4111-8111-111111111111"');
    expect(html).not.toContain("lucide-user");
  });
});
