...
import { MonitorsSettings, type MonitorSettingsData } from "./monitors-settings";
...
describe("MonitorsSettings", () => {
  it("renders the monitor row with Edit primary and View secondary", () => {
    ...
    expect(html).toContain('href="/monitors/api-prod"');
  ...
  it("renders an empty state without monitors", () => {
    const html = renderToStaticMarkup(<MonitorsSettings data={{ ...data, monitors: [] }} />);
