export { STORAGE_BUDGET_BYTES as DATABASE_STORAGE_BUDGET_BYTES } from "@/lib/storage/governor"
...
export type DatabaseHealthCategoryKey =
  (typeof DATABASE_HEALTH_CATEGORY_KEYS)[number]
export type AttributedDatabaseCategoryKey = Exclude<
