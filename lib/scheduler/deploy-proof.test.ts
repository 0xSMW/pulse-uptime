...
function run(
  partial: Partial<DeployProofRunSnapshot> &
    Pick<DeployProofRunSnapshot, "runId" | "status">
  ...
  return {
    ...
    completedAt:
      partial.status === "running"
        ? null
        : new Date("2026-07-20T12:01:10.000Z"),
    releaseId: RELEASE,
    ...partial,
  }
}
...
describe("parsePromotionBoundary", () => {
  it("accepts ISO timestamps and rejects bad input", () => {
    expect(
      parsePromotionBoundary("2026-07-20T12:00:00.000Z")?.toISOString()
