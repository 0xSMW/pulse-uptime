...
import { DependencyApiError, DependencyInstallConflictError } from "@/lib/dependencies/service";
...
export function dependencyErrorStatus(code: DependencyApiError["code"]): number {
...
export function dependencyError(error: unknown, requestId: string): Response | null {
...
export function storedDependencyError(error: unknown, requestId: string): StoredResponse | null {
