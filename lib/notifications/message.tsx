...
export function createNotificationMessage(
  ...
  switch (row.eventType) {
    case "incident.opened": {
      ...
      if (payload.type !== "incident.opened") {
        throw new InvalidNotificationPayloadError()
      }
      return {
        to: row.recipient,
    ...
    case "incident.resolved": {
      ...
      if (payload.type !== "incident.resolved") {
        throw new InvalidNotificationPayloadError()
      }
      return {
        to: row.recipient,
    ...
    case "notification.test": {
      ...
      if (payload.type !== "notification.test") {
        throw new InvalidNotificationPayloadError()
      }
      return {
        to: row.recipient,
    ...
    case "dependency.incident": {
      ...
      if (payload.type !== "dependency.incident") {
        throw new InvalidNotificationPayloadError()
      }
      return {
        to: row.recipient,
    ...
    case "dependency.recovery": {
      ...
      if (payload.type !== "dependency.recovery") {
        throw new InvalidNotificationPayloadError()
      }
      return {
        to: row.recipient,
