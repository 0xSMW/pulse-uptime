...
const categories = [
  {
    category: "hosting",
    presets: [
      { id: "vercel_runtime", name: "Vercel Runtime", provider: "Vercel", description: "Functions, CDN, routing, DNS.", scope: null, sourceScopeNote: null, fidelity: "component" as const, enabled: true, validated: true, hasValidationError: false, installed: false, installedScopeIds: [] },
    ],
  },
];
