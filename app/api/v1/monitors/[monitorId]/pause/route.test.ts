...
const monitor = {
  id: "site-home", name: "Site", url: "https://example.com", enabled: false, group: null, groupId: null,
...
function request(key = crypto.randomUUID()) {
  return new Request("https://pulse.test/api/v1/monitors/site-home/pause", {
    method: "POST",
...
describe("POST /api/v1/monitors/{monitorId}/pause", () => {
  it("pauses a monitor", async () => {
    ...
    expect(setMonitorEnabled).toHaveBeenCalledWith("site-home", false, context.principalKey, "tx");
  });
