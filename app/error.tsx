    ...
    <main className="mx-auto flex min-h-screen max-w-[420px] items-center px-6">
      <Card className="w-full p-6">
        <div className="flex items-center gap-2.5">
          <StatusDot aria-hidden state={DOT_STATE[diagnosis]} />
          <h1 className="font-semibold text-sm leading-5 tracking-[-0.28px]">
            {copy.title}
          </h1>
        </div>
        <p
          aria-live="polite"
          className="mt-2 text-[var(--fg-muted)] text-sm leading-5"
        >
          {copy.body}
        </p>
